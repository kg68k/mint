# winf_ss.s - mint v3 plug-in sample "winf ss" (based on "%winf 3")
...
make_filename_line_ss:

* %winf 3	" filename_________.jpeg filesize 99-02-16 00:00 "
* ss		" filename_________.jpeg $XXXXXXXX 01-C-17 00:00 "
...
@@:		bsr	make_filename_line_2d
		...
		lsr	#5,d0
		andi	#$f,d0			;月
		move.b	(month_table-1,pc,d0.w),(a1)+
		move.b	d2,(a1)+
...
title_mes:	.dc.b	'mint v3 plug-in sample "winf ss" version 1.01',CR,LF
		.dc.b	0
